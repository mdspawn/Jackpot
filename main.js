...
function setup(hasAccount) {
    ...
    var contract = web3.eth.contract(abiArray).at("0xc6b3136dabeed22a06ece83dc3e8d638a735c843");
...
window.addEventListener("load", function() {
	...
	$("#dividend-shares").text(failureText);
	$("#dividends").text(failureText);
        web3 = new Web3(new Web3.providers.HttpProvider("https://mainnet.infura.io/gfQ7T4BUfBX8neYtCwBz"));
        setup(false);
    }
});
